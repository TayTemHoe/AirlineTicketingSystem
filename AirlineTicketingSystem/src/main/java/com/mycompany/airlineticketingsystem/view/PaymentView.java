...
public class PaymentView {
    ...
    public void showPaymentScreen(String bookingID, double totalAmount) {
        stage = new Stage();
        ...
        try {
            scene.getStylesheets().add(getClass().getResource("/com/mycompany/airlineticketingsystem/customer-style.css").toExternalForm());
        } catch (Exception e) {
            System.out.println("⚠️ CSS Error: " + e.getMessage());
        }

        stage.setScene(scene);
        stage.showAndWait(); // Wait for user to pay or close
    }
    ...
    private void handlePayment(String bookingID, double amount) {
        ...
        if (success) {
            ...
            showAlert("Success", "Payment Approved! Generating Ticket...");
            stage.close();
        } else {
    ...
    private VBox createOptionBox(String name, String imageName) {
        ...
        try {
            String path = "/com/mycompany/airlineticketingsystem/images/" + imageName; 
